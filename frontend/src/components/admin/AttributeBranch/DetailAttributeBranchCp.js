...
const DetailAttributeBranchCp = () => {
  ...
  return (
    <>
      ...
      />
      {isModalCreateOpen && <CreateAtbBranchValueCp closeModal={closeCreateModal} attributeKeyBranchesId={id} />}
      {isModalUpdateOpen && <UpdateAtbBranchValueCp closeModal={closeUpdateModal} attributeKeyBranchesId={id} id={idSelected} />}
    </>
  );
};
