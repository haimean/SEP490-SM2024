...
const BranchFilter = ({ onFilterChange }) => {
  ...
  const handleProvinceChange = (event) => {
    ...
    onFilterChange(selectedOption.full_name, '', '', search);
  };
  ...
  const handleDistrictChange = (event) => {
    ...
    onFilterChange(selectedProvince.name, selectedOption.full_name, '', search);
  };
  ...
  const handleWardChange = (event) => {
    ...
    onFilterChange(selectedProvince.name, selectedDistrict.name, selectedOption.full_name, search);
  };

  const handleSearchChange = (event) => {
    setSearch(event.target.value);
    onFilterChange(selectedProvince.name, selectedDistrict.name, selectedWard.name, event.target.value);
  };
