...
export default function PrimarySearchAppBar() {
  ...
  const DrawerList = (
    ...
    >
      <List>
        <ListItem button component={Link} to="/admin/branch-attribute">
          <ListItemIcon>
            <InboxIcon />
          </ListItemIcon>
          <ListItemText primary="List Attribute Branch" />
        </ListItem>
        <ListItem button component={Link} to="/admin/court-attribute">
          <ListItemIcon>
            <InboxIcon />
          </ListItemIcon>
          <ListItemText primary="List Attribute Court" />
        </ListItem>
      </List>
      <Divider />
      <List>
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <LoginModal open={loginModalOpen} onClose={closeLoginModal} /> {/* Add the login modal here */}
    </Box>
  );
}
