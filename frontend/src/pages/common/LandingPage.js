        ...
        <section className="relative pt-10 overflow-hidden text-center text-white text-opacity-80 md:pt-20 bg-blue-400">
          <div className="max-w-screen-sm mx-auto">
            <div>
              ...
              <p className="mt-4">
                Our landing page template works for all the devices, so you only have
                to set it up once, and get beautiful results forever.
              </p>
              <p className="mt-6">
                <a className="inline-block px-6 py-3 bg-indigo-600 text-white rounded-lg shadow-lg hover:bg-indigo-700" href="#">
                  Get started now
                </a>
              </p>
              <div className="mt-8" />
        ...
        <section className="isolate block text-center">
          <div className="container">
            <div className="relative pt-3 pb-12 md:pt-20 md:pb-20">
              <h2 className="mb-12 md:mb-4 mt-0 font-bold text-2xl leading-10 tracking-[-0.1px] md:text-3xl md:leading-[46px] md:tracking-[-0.2px]">Product features</h2>
              <div className="flex flex-wrap justify-center mx-[-3px] last:mb-[-3px]">
                <div className="p-3 w-[276px] max-w-[276px] flex-grow">
                  <div className="relative h-full bg-white p-3 py-6 shadow-2xl">
                    ...
                    <h4 className="mt-6 mb-1 font-bold text-lg leading-7 tracking-[-0.1px] md:text-xl md:leading-8 md:tracking-[-0.1px]">Lorem Ipsum</h4>
                    <p className="text-lg leading-7 tracking-[-0.1px] mt-0 mb-6">
                      often arouses curiosity due to its resemblance to classical
                      latin
                    </p>
                  </div>
                </div>
            ...
            <div className="py-3 md:py-4 relative mx-40">
              <div className="text-center">
                <div className="container mx-auto px-6 sm:px-0 max-w-[800px] sm:max-w-[848px]">
                  <h2 className="mt-0 mb-4 font-bold text-3xl leading-10 tracking-[-0.1px] sm:text-4xl sm:leading-[46px] sm:tracking-[-0.2px]">Meet Evelyn</h2>
              ...
              <div className="pt-3 md:pt-4 md:flex md:items-center md:py-3 lg:px-4">
                ...
                <div className="lg:text-left text-center lg:px-40 md:px-24 px-4">
                  <h3 className="mt-0 mb-5 font-bold text-2xl sm:text-3xl leading-10 sm:leading-14 tracking-tighter sm:tracking-normal">Discover</h3>
                  <p className='mt-0 mb-6'>
                    Where text is visible, people tend to focus on the textual content
        ...
        <section className="block">
          <div className="container">
            <div className="relative py-12 sm:py-20">
              <h2 className="sm:mb-16 mt-0 text-center text-3xl sm:text-4xl leading-10 sm:leading-[46px] tracking-[-0.1px] sm:tracking-[-0.2px]">Pricing</h2>
              <div className="flex flex-wrap justify-center gap-x-4 sm:gap-x-8 md:gap-x-12">
                <div className="p-4 w-[344px] max-w-[344px] flex-grow shadow-2xl">
                  <div className="relative flex flex-wrap bg-white p-2 h-full">
                    <div className="relative w-full">
                      <div className="relative">
                        ...
                        <div className="mb-6 pb-8">
                          <span className="mt-0 mb-5 font-bold text-2xl sm:text-3xl leading-10 sm:leading-14 tracking-tighter sm:tracking-normal">$</span>
                    ...
                    <div className="relative w-full flex self-end">
                      <button className="bg-gradient-to-r from-teal-600 to-cyan-400 text-white transition duration-150 ease-in-out text-sm cursor-pointer w-full justify-center inline-flex items-center font-semibold uppercase tracking-wider focus:outline-none rounded-md px-8 py-4" href="#">
                        Get started now
                      </button>
                    </div>
                  </div>
                ...
                <div className="p-4 w-[344px] max-w-[344px] flex-grow shadow-2xl">
                  <div className="relative flex flex-wrap bg-white p-2 h-full">
                    ...
                    <div className="relative w-full flex self-end">
                      <button className="bg-gradient-to-r from-teal-600 to-cyan-400 text-white transition duration-150 ease-in-out text-sm cursor-pointer w-full justify-center inline-flex items-center px-8 py-4 font-semibold uppercase tracking-wider focus:outline-none rounded-md" href="#">
                        Get started now
                      </button>
                    </div>
                  </div>
